const config = {
  ...
  get sop_config() { return this.getDatabaseConfig('sop'); },
  get qa_config() { return this.getDatabaseConfig('qa'); },
  get design_config() { return this.getDatabaseConfig('design'); },
  get electrical_config() { return this.getDatabaseConfig('electrical'); },
  get overview_config() { return this.getDatabaseConfig('overview'); },
  get purchasing_config() { return this.getDatabaseConfig('purchasing'); },
};
